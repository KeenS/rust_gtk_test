...
trait GtkUtils {
    ...
    fn add_widget(
        ...
        winName: &'static str,
        boxName: &'static str,
        labelName: &'static str,
        widgetType: &'static str,
        expand: bool,
        fill: bool,
        padding: u32,
    );
    ...
    fn add_buttonWidget(
        ...
        winName: &'static str,
        boxName: &'static str,
        buttonName: &'static str,
        expand: bool,
        fill: bool,
        padding: u32,
    );
    fn add_winCloseEvent(
        &self,
        winName: &'static str,
        closure: impl std::ops::Fn(&gtk::Window, &gdk::Event) + 'static,
    );
}
...
impl GtkUtils for GtkConf {
    ...
    fn add_buttonWidget(
        ...
        self.add_widget(
            winName, boxName, buttonName, "button", expand, fill, padding,
        );
    }
    fn make_labelWidget(&mut self, name: &'static str, text: &str) {
...
fn main() {
    ...
    g.buttons["countUp_button"]
        .clone()
        .connect_clicked(move |_| {
            let old_num: u16 = label_c
                .get_text()
                .unwrap()
                .to_string()
                .parse::<u16>()
